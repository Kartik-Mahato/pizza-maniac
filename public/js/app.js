...
function initAdmin() {
  ...
  var orders = [];
  var markup;
  axios__WEBPACK_IMPORTED_MODULE_0___default().get('orders', {
    headers: {
...
socket.on('orderUpdated', function (data) {
  ...
  updatedOrder.updateAt = moment__WEBPACK_IMPORTED_MODULE_1___default()().format();
